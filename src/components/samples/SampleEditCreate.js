...
class SampleEditCreate extends Component {
    ...
    onViewReport(e) {
        ...
        this.context.router.push(`/report/${oState.sample.id}`);
    }
            ...
            <div>
                <div className="container-print">
                    <span style={{ fontSize: '2em', cursor: 'pointer' }} className="hidden-print">
                        ...
                        <span className="pull-right">&nbsp;</span>
                        <button onClick={this.onViewReport.bind(this)} className="btn btn-lg btn-primary pull-right">View Report</button>
                    </span>
